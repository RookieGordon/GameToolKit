...
{
    // —— 假资源 ——
    public sealed class FakeAsset { public string Name; }                 // 共享资源 (不可实例化)
    public sealed class FakePrefab { public string Name; }                // 可实例化原型
    ...
    public sealed class FakeLoader : ILoader
    {
        ...
        public Task<IAssetHandle> LoadAsync(
