...
namespace Tests
{
    ...
    public static class Helper
    {
        public static void StartBehaviourTree(BehaviourTree tree)
        {
            ...
            tree.Blackboard = blackboardProxy.Blackboard;
            tree.Start();
            tree.BeginTraversal();
        }
        ...
        {
            return ScriptableObject.CreateInstance<BehaviourTreeProxy>().Tree;
        }

        static public T CreateNode<T>() where T : BehaviourNode
        {
            return ScriptableObject.CreateInstance<BehaviourNodeProxy>().Node as T;
        }
