...
namespace Bonsai.Designer
{
    public class EditorSelection : IReadOnlySelection
    {
        ...
        /// </summary>
        public IReadOnlyList<BonsaiNode> SelectedNodes
        {
        ...
        /// </summary>
        public IReadOnlyList<BehaviourNode> Referenced
        {
            get { return referencedNodes; }
        }
        ...
        public void SetMultiSelection(List<BonsaiNode> newSelection)
        {
            ...
            else
            {
                ...
                if (newSelection.Count > 0)
                {
                    ...
                    Selection.objects = newSelection.Select(node => node.Behaviour.Proxy).ToArray();
                }
            }
        }
        ...
        public void SetSingleSelection(BonsaiNode newSingleSelected)
        {
            ...
            Selection.activeObject = newSingleSelected.Behaviour.Proxy;
        ...
        public void ToggleSelecion(BonsaiNode node)
        {
            ...
            if (IsSingleSelection)
            {
                ...
                Selection.objects = null;
                Selection.activeObject = selectedNode.Behaviour.Proxy;
            ...
            {
                Selection.objects = selectedNodes.Select(n => n.Behaviour.Proxy).ToArray();
            }
        }
        ...
        public void SetTreeSelection(BehaviourTree tree)
        {
            ...
            ClearSelection();
            Selection.activeObject = tree.Proxy;
        }
