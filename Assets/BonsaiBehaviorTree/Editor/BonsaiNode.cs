...
namespace Bonsai.Designer
{
    public class BonsaiNode : IIterableNode<BonsaiNode>
    {
        ...
        public IReadOnlyList<BonsaiNode> Children
        {
            get { return children; }
        }
        ...
        public void SetBehaviour(BehaviourNode newBehaviour, Texture icon)
        {
            ...
            Object.DestroyImmediate(behaviour.Proxy, true);
            behaviour = null;
        ...
        {
            string text = behaviour.Proxy.title;
        ...
        private string BodyText()
        {
            ...
            if (!string.IsNullOrEmpty(behaviour.Proxy.comment))
            {
                text.AppendLine();
                text.AppendLine();
                text.Append(behaviour.Proxy.comment);
            }
