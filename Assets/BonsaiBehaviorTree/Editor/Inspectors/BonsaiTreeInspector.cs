...
{
    [CustomEditor(typeof(BehaviourTreeProxy))]
    public class BonsaiTreeInspector : Editor
    {
        ...
        private void ShowTreeStats(BehaviourTree tree)
        {
            if (EditorApplication.isPlaying && tree.IsInitialized())
            {
                ...
                EditorGUILayout.LabelField("Observer count",
                    tree.Blackboard != null ? tree.Blackboard.ObserverCount.ToString() : "0");
            }
        }
