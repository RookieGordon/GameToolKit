...
namespace Bonsai.Designer
{
    ...
    public static class Drawer
    {
        ...
        public static void DrawExitStatus(BonsaiNode node)
        {
            ...
            var status = node.Behaviour.Proxy.StatusEditorResult;
        ...
        public static void DrawNodeConnections(CanvasTransform t, BonsaiNode node)
        {
            ...
            if (node.Behaviour.Proxy.StatusEditorResult == Core.BehaviourNode.StatusEditor.Running)
            {
            ...
            foreach (BonsaiNode child in node.Children)
            {
                ...
                if (child.Behaviour.Proxy.StatusEditorResult == Core.BehaviourNode.StatusEditor.Running)
                {
                    DrawLineCanvasSpace(
                        t,
                        center,
