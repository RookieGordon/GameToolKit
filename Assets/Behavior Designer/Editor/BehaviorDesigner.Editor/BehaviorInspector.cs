...
namespace BehaviorDesigner.Editor
{
  ...
  public class BehaviorInspector : UnityEditor.Editor
  {
      ...
      ref bool showVariables)
    {
      ...
      behavior.GetBehaviorSource().behaviorDescription = EditorGUILayout.TextArea(behavior.GetBehaviorSource().behaviorDescription, BehaviorDesignerUtility.TaskInspectorCommentGUIStyle, new GUILayoutOption[1]
      {
      ...
      if (!object.ReferenceEquals((object) behavior.ExternalBehavior, (object) null) && !((object) behavior.ExternalBehavior).Equals((object) objectReferenceValue) || !object.ReferenceEquals((object) objectReferenceValue, (object) null) && !((object) objectReferenceValue).Equals((object) behavior.ExternalBehavior))
      {
