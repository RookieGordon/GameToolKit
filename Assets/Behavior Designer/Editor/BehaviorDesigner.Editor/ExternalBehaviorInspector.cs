...
namespace BehaviorDesigner.Editor
{
    ...
    public class ExternalBehaviorInspector : UnityEditor.Editor
    {
            ...
            ref bool showVariables)
        {
            ...
            behaviorSource.behaviorDescription = EditorGUILayout.TextArea(behaviorSource.behaviorDescription,
                new GUILayoutOption[1]
                {
            ...
            if (fromInspector)
            {
                ...
                if (showVariables = EditorGUILayout.Foldout(EditorPrefs.GetBool(str, true), "Variables"))
                {
                    ...
                    if (allVariables != null && VariableInspector.DrawAllVariables(false,
                            (IVariableSource)behaviorSource,
                            ref allVariables,
                            false,
                            ref ExternalBehaviorInspector.variablePosition,
                            ref ExternalBehaviorInspector.selectedVariableIndex,
                            ref ExternalBehaviorInspector.selectedVariableName,
                            ref ExternalBehaviorInspector.selectedVariableTypeIndex,
                            true,
                            false))
                    {
