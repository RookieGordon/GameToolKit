...
namespace BehaviorDesigner.Editor
{
  ...
  public class NodeDesigner : ScriptableObject
  {
    ...
    public bool DrawNode(Vector2 offset, bool drawSelected, bool disabled)
    {
      ...
      bool flag1 = (double) this.mTask.NodeData.PushTime != -1.0 && (double) this.mTask.NodeData.PushTime >= (double) this.mTask.NodeData.PopTime || this.isEntryDisplay && this.outgoingNodeConnections.Count > 0 && (double) this.outgoingNodeConnections[0].DestinationNodeDesigner.Task.NodeData.PushTime != -1.0;
      ...
      if (flag2)
      {
        ...
        num2 = 1f;
      else if ((double) this.mTask.NodeData.PopTime != -1.0 && (double) num1 != 0.0 && (double) this.mTask.NodeData.PopTime <= (double) Time.realtimeSinceStartup && (double) Time.realtimeSinceStartup - (double) this.mTask.NodeData.PopTime < (double) num1 || this.isEntryDisplay && this.outgoingNodeConnections.Count > 0 && (double) this.outgoingNodeConnections[0].DestinationNodeDesigner.Task.NodeData.PopTime != -1.0 && (double) this.outgoingNodeConnections[0].DestinationNodeDesigner.Task.NodeData.PopTime <= (double) Time.realtimeSinceStartup && (double) Time.realtimeSinceStartup - (double) this.outgoingNodeConnections[0].DestinationNodeDesigner.Task.NodeData.PopTime < (double) num1)
      {
        num2 = !this.isEntryDisplay ? (float) (1.0 - ((double) Time.realtimeSinceStartup - (double) this.mTask.NodeData.PopTime) / (double) num1) : (float) (1.0 - ((double) Time.realtimeSinceStartup - (double) this.outgoingNodeConnections[0].DestinationNodeDesigner.Task.NodeData.PopTime) / (double) num1);
        flag3 = true;
      }
      ...
      if ((double) num2 != 1.0)
      {
        ...
        GUIStyle backgroundGUIStyle = !BehaviorDesignerPreferences.GetBool(BDPreferences.CompactMode) ? (!this.mSelected ? BehaviorDesignerUtility.GetTaskGUIStyle(this.mTask.NodeData.ColorIndex) : BehaviorDesignerUtility.GetTaskSelectedGUIStyle(this.mTask.NodeData.ColorIndex)) : (!this.mSelected ? BehaviorDesignerUtility.GetTaskCompactGUIStyle(this.mTask.NodeData.ColorIndex) : BehaviorDesignerUtility.GetTaskSelectedCompactGUIStyle(this.mTask.NodeData.ColorIndex));
