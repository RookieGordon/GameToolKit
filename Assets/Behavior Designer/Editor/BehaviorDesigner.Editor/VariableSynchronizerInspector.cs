...
namespace BehaviorDesigner.Editor
{
    ...
    {
        [SerializeField] private VariableSynchronizerInspector.Synchronizer sharedVariableSynchronizer = new VariableSynchronizerInspector.Synchronizer();
        [SerializeField] private string sharedVariableValueTypeName;
        private System.Type sharedVariableValueType;
        [SerializeField] private VariableSynchronizer.SynchronizationType synchronizationType;
        [SerializeField] private bool setVariable;
        [SerializeField] private VariableSynchronizerInspector.Synchronizer targetSynchronizer;
        ...
        public virtual void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                if (GUILayout.Button((Texture)BehaviorDesignerUtility.LoadTexture(!this.setVariable ? "RightArrowButton.png" : "LeftArrowButton.png", obj: ((UnityEngine.Object)this)),
                        BehaviorDesignerUtility.ButtonGUIStyle,
                        new GUILayoutOption[1]
                        {
                            GUILayout.Width(22f)
                        }))
                ...
                if (GUILayout.Button("Add", Array.Empty<GUILayoutOption>()))
                {
                    VariableSynchronizer.SynchronizedVariable synchronizedVariable = new VariableSynchronizer.SynchronizedVariable(this.synchronizationType,
                        this.setVariable,
                        this.sharedVariableSynchronizer.component as Behavior,
                        this.sharedVariableSynchronizer.targetName,
                        this.sharedVariableSynchronizer.global,
                        this.targetSynchronizer.component,
                        this.targetSynchronizer.targetName,
                        this.targetSynchronizer.global);
        ...
        private void DrawSynchronizedVariables(VariableSynchronizer variableSynchronizer)
        {
            ...
            for (int index = 0; index < variableSynchronizer.SynchronizedVariables.Count; ++index)
            {
                ...
                EditorGUILayout.BeginHorizontal(Array.Empty<GUILayoutOption>());
                EditorGUILayout.LabelField(synchronizedVariable.variableName,
                    new GUILayoutOption[1]
                    {
                        GUILayout.MaxWidth(120f)
                    });
                if (GUILayout.Button((Texture)BehaviorDesignerUtility.LoadTexture(!synchronizedVariable.setVariable ? "RightArrowButton.png" : "LeftArrowButton.png", obj: ((UnityEngine.Object)this)),
                        BehaviorDesignerUtility.ButtonGUIStyle,
                        new GUILayoutOption[1]
                        {
                            GUILayout.Width(22f)
                ...
                EditorGUILayout.LabelField(string.Format("{0} ({1})", (object)synchronizedVariable.targetName, (object)synchronizedVariable.synchronizationType.ToString()),
                    new GUILayoutOption[1]
                    {
                        GUILayout.MinWidth(120f)
                    });
                GUILayout.FlexibleSpace();
                if (GUILayout.Button((Texture)BehaviorDesignerUtility.LoadTexture("DeleteButton.png", obj: ((UnityEngine.Object)this)),
                        BehaviorDesignerUtility.ButtonGUIStyle,
                        new GUILayoutOption[1]
                        {
                            GUILayout.Width(22f)
