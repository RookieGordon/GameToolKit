...
namespace BehaviorDesigner.Editor
{
    public class JSONSerialization : UnityEngine.Object
    {
            ...
            ref List<UnityEngine.Object> unityObjects)
        {
            ...
            {
                if (!BehaviorDesignerUtility.HasAttribute(serializableFields[index1], typeof(NonSerializedAttribute)) && (!serializableFields[index1].IsPrivate && !serializableFields[index1].IsFamily || BehaviorDesignerUtility.HasAttribute(serializableFields[index1], typeof(SerializeField))) &&
                    (!(obj is ParentTask) || !serializableFields[index1].Name.Equals("children")) && serializableFields[index1].GetValue(obj) != null)
                {
                        ...
                        if (serializableFields[index1].GetValue(obj) is IList list)
                        {
                            ...
                            for (int index2 = 0; index2 < list.Count; ++index2)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (type.IsPrimitive || type.IsEnum || type.Equals(typeof(string)) || type.Equals(typeof(Vector2)) || type.Equals(typeof(Vector2Int)) || type.Equals(typeof(Vector3)) || type.Equals(typeof(Vector3Int)) || type.Equals(typeof(Vector4)) ||
                                             type.Equals(typeof(Quaternion)) || type.Equals(typeof(Matrix4x4)) || type.Equals(typeof(Color)) || type.Equals(typeof(Rect)))
                                    {
                    ...
                    else if (serializableFields[index1].FieldType.IsPrimitive || serializableFields[index1].FieldType.IsEnum || serializableFields[index1].FieldType.Equals(typeof(string)) || serializableFields[index1].FieldType.Equals(typeof(Vector2)) ||
                             serializableFields[index1].FieldType.Equals(typeof(Vector2Int)) || serializableFields[index1].FieldType.Equals(typeof(Vector3)) || serializableFields[index1].FieldType.Equals(typeof(Vector3Int)) || serializableFields[index1].FieldType.Equals(typeof(Vector4)) ||
                             serializableFields[index1].FieldType.Equals(typeof(Quaternion)) || serializableFields[index1].FieldType.Equals(typeof(Matrix4x4)) || serializableFields[index1].FieldType.Equals(typeof(Color)) || serializableFields[index1].FieldType.Equals(typeof(Rect)))
