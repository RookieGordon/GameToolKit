...
namespace BehaviorDesigner.Editor
{
    public class VariableInspector : ScriptableObject
    {
        ...
        [SerializeField] private float mVariableStartPosition = -1f;
        [SerializeField] private List<float> mVariablePosition;
        [SerializeField] private int mSelectedVariableIndex = -1;
        [SerializeField] private string mSelectedVariableName;
        [SerializeField] private int mSelectedVariableTypeIndex;
        ...
        public bool DrawVariables(BehaviorSource behaviorSource) => VariableInspector.DrawVariables((IVariableSource)behaviorSource,
            behaviorSource,
            ref this.mVariableName,
            ref this.mFocusNameField,
            ref this.mVariableTypeIndex,
            ref this.mScrollPosition,
            ref this.mVariablePosition,
            ref this.mVariableStartPosition,
            ref this.mSelectedVariableIndex,
            ref this.mSelectedVariableName,
            ref this.mSelectedVariableTypeIndex);
            ...
            ref int selectedVariableTypeIndex)
        {
            ...
            variableTypeIndex = EditorGUILayout.Popup(variableTypeIndex,
                VariableInspector.sharedVariableStrings,
                EditorStyles.popup,
                new GUILayoutOption[1]
                {
            ...
            if (!fromGlobalVariablesWindow)
            {
                ...
                GUILayout.BeginHorizontal(Array.Empty<GUILayoutOption>());
                GUILayout.Space(5f);
                if (GUILayout.Button("Global Variables",
                        EditorStyles.miniButton,
                        new GUILayoutOption[1]
                        {
            ...
            for (int index = 0; index < variables.Count; ++index)
            {
                ...
                if (sharedVariable != null && !sharedVariable.IsDynamic)
                {
                    ...
                    else
                    {
                        ...
                        if (drawRemoveButton)
                        {
                            if (GUILayout.Button((Texture)BehaviorDesignerUtility.VariableDeleteButtonTexture,
            ...
            bool selected)
        {
            ...
            {
                if (GUILayout.Button((Texture)BehaviorDesignerUtility.VariableMapButtonTexture,
                        BehaviorDesignerUtility.PlainButtonGUIStyle,
                        new GUILayoutOption[1]
                        {
                            GUILayout.Width(19f)
            ...
            ref bool deleted)
        {
            ...
            selectedVariableName = EditorGUILayout.TextField(selectedVariableName,
                new GUILayoutOption[1]
                {
            ...
            if (GUILayout.Button((Texture)BehaviorDesignerUtility.DownArrowButtonTexture,
                    BehaviorDesignerUtility.PlainButtonGUIStyle,
                    new GUILayoutOption[1]
                    {
                        GUILayout.Width(19f)
            ...
            if (GUILayout.Button((Texture)BehaviorDesignerUtility.UpArrowButtonTexture,
                    BehaviorDesignerUtility.PlainButtonGUIStyle,
                    new GUILayoutOption[1]
                    {
                        GUILayout.Width(20f)
            ...
            EditorGUI.BeginChangeCheck();
            selectedVariableTypeIndex = EditorGUILayout.Popup(selectedVariableTypeIndex,
                VariableInspector.sharedVariableStrings,
            ...
            EditorGUI.BeginChangeCheck();
            sharedVariable.Tooltip = EditorGUILayout.TextField(sharedVariable.Tooltip,
                new GUILayoutOption[1]
                {
                    GUILayout.Width(200f)
                });
        ...
        private static bool CanNetworkSync(System.Type type) => type == typeof(bool) || type == typeof(Color) || type == typeof(float) || type == typeof(GameObject) || type == typeof(int) || type == typeof(Quaternion) || type == typeof(Rect) || type == typeof(string) || type == typeof(Transform) ||
