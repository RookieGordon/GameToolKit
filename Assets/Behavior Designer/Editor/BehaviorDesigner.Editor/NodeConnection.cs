...
namespace BehaviorDesigner.Editor
{
    ...
    public class NodeConnection : ScriptableObject
    {
        ...
        public void DrawConnection(Vector2 source, Vector2 destination, bool disabled)
        {
            ...
            bool flag = (UnityEngine.Object)this.destinationNodeDesigner != (UnityEngine.Object)null && this.destinationNodeDesigner.Task != null && (double)this.destinationNodeDesigner.Task.NodeData.PushTime != -1.0 &&
                        (double)this.destinationNodeDesigner.Task.NodeData.PushTime >= (double)this.destinationNodeDesigner.Task.NodeData.PopTime;
            ...
            else if ((double)num != 0.0 && (UnityEngine.Object)this.destinationNodeDesigner != (UnityEngine.Object)null && this.destinationNodeDesigner.Task != null && (double)this.destinationNodeDesigner.Task.NodeData.PopTime != -1.0 &&
                     (double)this.destinationNodeDesigner.Task.NodeData.PopTime <= (double)Time.realtimeSinceStartup && (double)Time.realtimeSinceStartup - (double)this.destinationNodeDesigner.Task.NodeData.PopTime < (double)num)
            {
        ...
        public bool Contains(Vector2 point, Vector2 offset)
        {
            ...
            return (double)Mathf.Abs(point.y - this.horizontalHeight) < 7.0 && ((double)point.x <= (double)center.x && (double)point.x >= (double)vector2_3.x || (double)point.x >= (double)center.x && (double)point.x <= (double)vector2_3.x) ||
                   (double)Mathf.Abs(point.x - vector2_2.x) < 7.0 && ((double)point.y >= (double)vector2_2.y && (double)point.y <= (double)vector2_3.y || (double)point.y <= (double)vector2_2.y && (double)point.y >= (double)vector2_3.y);
        }
    }
}