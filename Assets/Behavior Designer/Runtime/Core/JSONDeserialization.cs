...
namespace BehaviorDesigner.Runtime
{
  public class JSONDeserialization : UnityEngine.Object
  {
      ...
      bool loadTasks)
    {
      ...
      else
      {
        ...
        foreach (JSONDeserialization.TaskField key in JSONDeserialization.taskIDs.Keys)
        {
          ...
          {
            Task task;
            if (IDtoTask.TryGetValue(taskId[0], out task) && (task.GetType().Equals(key.fieldInfo.FieldType) || task.GetType().IsSubclassOf(key.fieldInfo.FieldType)))
      ...
      List<UnityEngine.Object> unityObjects)
    {
      ...
      try
      {
        ...
        if (t == (System.Type) null)
          t = !dict.ContainsKey("Children") ? typeof (UnknownTask) : typeof (UnknownParentTask);
      ...
      if (task is ParentTask && dict.TryGetValue("Children", out obj) && task is ParentTask parentTask)
      {
    ...
    private static NodeData DeserializeNodeData(Dictionary<string, object> dict, Task task)
    {
      ...
      object vector2String;
      if (dict.TryGetValue("Offset", out vector2String))
      ...
      if (dict.TryGetValue("IsBreakpoint", out vector2String))
        nodeData.IsBreakpoint = Convert.ToBoolean(vector2String, (IFormatProvider) CultureInfo.InvariantCulture);
      if (dict.TryGetValue("Collapsed", out vector2String))
        nodeData.Collapsed = Convert.ToBoolean(vector2String, (IFormatProvider) CultureInfo.InvariantCulture);
      if (dict.TryGetValue("ColorIndex", out vector2String))
        nodeData.ColorIndex = Convert.ToInt32(vector2String, (IFormatProvider) CultureInfo.InvariantCulture);
      ...
      List<UnityEngine.Object> unityObjects)
    {
      ...
      object name;
      if (!fromSource && variableSource != null && dict.TryGetValue("Name", out name) && (BehaviorManager.IsPlaying || !dict.ContainsKey("IsDynamic")))
      {
        object obj;
        dict.TryGetValue("IsGlobal", out obj);
        if (!dict.TryGetValue("IsGlobal", out obj) || !Convert.ToBoolean(obj, (IFormatProvider) CultureInfo.InvariantCulture))
        {
          sharedVariable = variableSource.GetVariable(name as string);
        }
        else
        {
          if ((UnityEngine.Object) JSONDeserialization.globalVariables == (UnityEngine.Object) null)
            JSONDeserialization.globalVariables = GlobalVariables.Instance;
          if ((UnityEngine.Object) JSONDeserialization.globalVariables != (UnityEngine.Object) null)
            sharedVariable = JSONDeserialization.globalVariables.GetVariable(name as string);
        }
      }
      ...
      if (sharedVariable == null || !(flag = sharedVariable.GetType().Equals(typeWithinAssembly)))
      {
        ...
        if (dict.TryGetValue("IsShared", out obj))
          sharedVariable.IsShared = Convert.ToBoolean(obj, (IFormatProvider) CultureInfo.InvariantCulture);
        if (dict.TryGetValue("IsGlobal", out obj))
          sharedVariable.IsGlobal = Convert.ToBoolean(obj, (IFormatProvider) CultureInfo.InvariantCulture);
        if (dict.TryGetValue("IsDynamic", out obj))
        {
          sharedVariable.IsDynamic = Convert.ToBoolean(obj, (IFormatProvider) CultureInfo.InvariantCulture);
        ...
        if (!sharedVariable.IsGlobal && dict.TryGetValue("PropertyMapping", out obj))
        {
          ...
          if (dict.TryGetValue("PropertyMappingOwner", out obj))
            sharedVariable.PropertyMappingOwner = JSONDeserialization.IndexToUnityObject(Convert.ToInt32(obj, (IFormatProvider) CultureInfo.InvariantCulture), unityObjects) as GameObject;
      ...
      List<UnityEngine.Object> unityObjects)
    {
      ...
      for (int index1 = 0; index1 < serializableFields.Length; ++index1)
      {
        ...
        string key = !JSONDeserialization.updatedSerialization ? (serializableFields[index1].FieldType.Name.GetHashCode() + serializableFields[index1].Name.GetHashCode()).ToString() : serializableFields[index1].FieldType.Name + serializableFields[index1].Name;
        if (!dict.TryGetValue(key, out obj1) && serializableFields[index1].GetCustomAttribute(typeof (FormerlySerializedAsAttribute), true) is FormerlySerializedAsAttribute customAttribute)
          dict.TryGetValue(serializableFields[index1].FieldType.Name + customAttribute.oldName, out obj1);
        if (obj1 != null)
        {
          if (typeof (IList).IsAssignableFrom(serializableFields[index1].FieldType))
          {
            if (obj1 is IList list)
            {
              ...
              if ((elementType.Equals(typeof (Task)) || elementType.IsSubclassOf(typeof (Task))) && !TaskUtility.HasAttribute(serializableFields[index1], typeof (InspectTaskAttribute)))
              {
                if (JSONDeserialization.taskIDs != null)
                {
                  ...
                  JSONDeserialization.taskIDs.Add(new JSONDeserialization.TaskField(task, serializableFields[index1]), intList);
                }
              }
              else if (serializableFields[index1].FieldType.IsArray)
              {
                ...
                for (int index3 = 0; index3 < list.Count; ++index3)
                {
                  ...
                  else
                  {
                    ...
                    {
                      Dictionary<string, object> dictionary = (Dictionary<string, object>) list[index3];
                    ...
                    object o = JSONDeserialization.ValueToObject(task, type, obj2, variableSource, unityObjects);
              ...
              else
              {
                ...
                if (serializableFields[index1].FieldType.IsGenericType)
                  instance = TaskUtility.CreateInstance(typeof (List<>).MakeGenericType(elementType)) as IList;
                else
                  instance = TaskUtility.CreateInstance(serializableFields[index1].FieldType) as IList;
                for (int index4 = 0; index4 < list.Count; ++index4)
                {
                  ...
                  else
                  {
                    ...
                    object obj4 = JSONDeserialization.ValueToObject(task, type, obj3, variableSource, unityObjects);
          ...
          else
          {
            ...
            if (fieldType.Equals(typeof (Task)) || fieldType.IsSubclassOf(typeof (Task)))
            {
              if (TaskUtility.HasAttribute(serializableFields[index1], typeof (InspectTaskAttribute)))
              {
                ...
                if (typeWithinAssembly != (System.Type) null)
                {
                  ...
                  serializableFields[index1].SetValue((object) task, (object) instance);
                }
              }
              else if (JSONDeserialization.taskIDs != null)
                JSONDeserialization.taskIDs.Add(new JSONDeserialization.TaskField(task, serializableFields[index1]), new List<int>()
                {
            ...
            {
              object obj5 = JSONDeserialization.ValueToObject(task, fieldType, obj1, variableSource, unityObjects);
              if (obj5 != null && !obj5.Equals((object) null) && fieldType.IsAssignableFrom(obj5.GetType()))
                serializableFields[index1].SetValue(obj, obj5);
            }
          }
        }
        else if (typeof (SharedVariable).IsAssignableFrom(serializableFields[index1].FieldType) && !serializableFields[index1].FieldType.IsAbstract)
        {
          if (dict.TryGetValue((serializableFields[index1].FieldType.Name.GetHashCode() + serializableFields[index1].Name.GetHashCode()).ToString(), out obj1))
          {
            SharedVariable instance = TaskUtility.CreateInstance(serializableFields[index1].FieldType) as SharedVariable;
            instance.SetValue(JSONDeserialization.ValueToObject(task, serializableFields[index1].FieldType, obj1, variableSource, unityObjects));
            serializableFields[index1].SetValue(obj, (object) instance);
          }
          else
          {
            SharedVariable instance = TaskUtility.CreateInstance(serializableFields[index1].FieldType) as SharedVariable;
            if (serializableFields[index1].GetValue(obj) is SharedVariable sharedVariable)
    ...
    {
      string[] strArray = vector2String.Substring(1, vector2String.Length - 2).Split(',');
      return new Vector2Int(int.Parse(strArray[0], (IFormatProvider) CultureInfo.InvariantCulture), int.Parse(strArray[1], (IFormatProvider) CultureInfo.InvariantCulture));
    }
    ...
    {
      string[] strArray = vector3String.Substring(1, vector3String.Length - 2).Split(',');
      return new Vector3Int(int.Parse(strArray[0], (IFormatProvider) CultureInfo.InvariantCulture), int.Parse(strArray[1], (IFormatProvider) CultureInfo.InvariantCulture), int.Parse(strArray[2], (IFormatProvider) CultureInfo.InvariantCulture));
    }
    ...
    private static Matrix4x4 StringToMatrix4x4(string matrixString)
    {
      ...
      {
        m00 = float.Parse(strArray[0], (IFormatProvider) CultureInfo.InvariantCulture),
        m01 = float.Parse(strArray[1], (IFormatProvider) CultureInfo.InvariantCulture),
        m02 = float.Parse(strArray[2], (IFormatProvider) CultureInfo.InvariantCulture),
        m03 = float.Parse(strArray[3], (IFormatProvider) CultureInfo.InvariantCulture),
        m10 = float.Parse(strArray[4], (IFormatProvider) CultureInfo.InvariantCulture),
        m11 = float.Parse(strArray[5], (IFormatProvider) CultureInfo.InvariantCulture),
        m12 = float.Parse(strArray[6], (IFormatProvider) CultureInfo.InvariantCulture),
        m13 = float.Parse(strArray[7], (IFormatProvider) CultureInfo.InvariantCulture),
        m20 = float.Parse(strArray[8], (IFormatProvider) CultureInfo.InvariantCulture),
        m21 = float.Parse(strArray[9], (IFormatProvider) CultureInfo.InvariantCulture),
        m22 = float.Parse(strArray[10], (IFormatProvider) CultureInfo.InvariantCulture),
        m23 = float.Parse(strArray[11], (IFormatProvider) CultureInfo.InvariantCulture),
        m30 = float.Parse(strArray[12], (IFormatProvider) CultureInfo.InvariantCulture),
        m31 = float.Parse(strArray[13], (IFormatProvider) CultureInfo.InvariantCulture),
        m32 = float.Parse(strArray[14], (IFormatProvider) CultureInfo.InvariantCulture),
        m33 = float.Parse(strArray[15], (IFormatProvider) CultureInfo.InvariantCulture)
      };
    }
    ...
    private static LayerMask ValueToLayerMask(int value) => new LayerMask()
    {
      value = value
    };
    ...
    private static UnityEngine.Object IndexToUnityObject(int index, List<UnityEngine.Object> unityObjects) => index < 0 || index >= unityObjects.Count ? (UnityEngine.Object) null : unityObjects[index];
