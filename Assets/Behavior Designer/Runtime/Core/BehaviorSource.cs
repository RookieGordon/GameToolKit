...
namespace BehaviorDesigner.Runtime
{
  ...
  public class BehaviorSource : IVariableSource
  {
    ...
    public BehaviorSource(IBehavior owner) => this.Initialize(owner);
    ...
    public void Initialize(IBehavior owner) => this.mOwner = owner;
    ...
    {
      if (this.mOwner == null || this.mOwner.GetObject() == (UnityEngine.Object) null)
        return this.behaviorName;
      return string.IsNullOrEmpty(this.behaviorName) ? this.Owner.GetOwnerName() : string.Format("{0} - {1}", (object) this.Owner.GetOwnerName(), (object) this.behaviorName);
    }
  }
}
