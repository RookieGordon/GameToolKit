...
namespace BehaviorDesigner.Runtime
{
  public class TaskUtility
  {
    ...
    private static Dictionary<System.Type, FieldInfo[]> allFieldsLookup = new Dictionary<System.Type, FieldInfo[]>();
    private static Dictionary<System.Type, FieldInfo[]> serializableFieldsLookup = new Dictionary<System.Type, FieldInfo[]>();
    private static Dictionary<System.Type, FieldInfo[]> publicFieldsLookup = new Dictionary<System.Type, FieldInfo[]>();
    private static Dictionary<FieldInfo, Dictionary<System.Type, bool>> hasFieldLookup = new Dictionary<FieldInfo, Dictionary<System.Type, bool>>();
    ...
    private static void GetSerializableFields(System.Type t, IList<FieldInfo> fieldList, int flags)
    {
      if (t == (System.Type) null || t.Equals(typeof (ParentTask)) || t.Equals(typeof (Task)) || t.Equals(typeof (SharedVariable)))
        return;
      FieldInfo[] fields = t.GetFields((BindingFlags) flags);
      for (int index = 0; index < fields.Length; ++index)
      {
        if (fields[index].IsPublic || TaskUtility.HasAttribute(fields[index], typeof (SerializeField)))
