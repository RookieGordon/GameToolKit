    ...
    public abstract class SharedVariable<T> : SharedVariable
    {
        ...
        public override void InitializePropertyMapping(BehaviorSource behaviorSource)
        {
            ...
            if ((UnityEngine.Object)gameObject == (UnityEngine.Object)null)
            {
                Debug.LogError(
                    (object)(
                        "Error: Unable to find GameObject on "
                        + behaviorSource.behaviorName
                        + " for property mapping with variable "
                        + this.Name
                    )
                );
            }
            else
            {
                ...
                if ((UnityEngine.Object)component == (UnityEngine.Object)null)
                {
                    Debug.LogError(
                        (object)(
                            "Error: Unable to find component on "
                            + behaviorSource.behaviorName
                            + " for property mapping with variable "
                            + this.Name
                        )
        ...
        public override string ToString() =>
            (object)this.Value == null ? "(null)" : this.Value.ToString();
    }
}
