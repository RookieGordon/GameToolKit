  ...
  public class VariableSynchronizer : MonoBehaviour
  {
    ...
    public void Awake()
    {
      for (int index = this.synchronizedVariables.Count - 1; index > -1; --index)
      {
        ...
        {
          UnityEngine.Debug.LogError((object) string.Format("Unable to synchronize {0}: {1}", (object) synchronizedVariable.sharedVariable.Name, (object) str));
    ...
    private static Func<object> CreateGetDelegate(object instance, MethodInfo method)
    {
      ...
      return Expression.Lambda<Func<object>>((Expression) Expression.Call(instance1, method)).Compile();
    }
    ...
    private static Action<object> CreateSetDelegate(object instance, MethodInfo method)
    {
      ...
      return Expression.Lambda<Action<object>>((Expression) Expression.Call((Expression) instance1, method, (Expression) unaryExpression), parameterExpression).Compile();
    }
