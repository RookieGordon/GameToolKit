...
public static class BinaryDeserialization
{
  ...
  private static Dictionary<BinaryDeserialization.ObjectFieldMap, List<int>> taskIDs = (Dictionary<BinaryDeserialization.ObjectFieldMap, List<int>>) null;
  ...
  public static void Load(BehaviorSource behaviorSource) => BinaryDeserialization.Load(behaviorSource.TaskData, behaviorSource, true);
    ...
    bool loadTasks)
  {
    ...
    if (taskSerializationData == null || ((serializationData = taskSerializationData.fieldSerializationData).byteData == null || serializationData.byteData.Count == 0) && (serializationData.byteDataArray == null || serializationData.byteDataArray.Length == 0))
      return;
    ...
    if (taskSerializationData.variableStartIndex != null)
    {
      ...
      for (int index1 = 0; index1 < taskSerializationData.variableStartIndex.Count; ++index1)
      {
        ...
        int num3 = index1 + 1 >= taskSerializationData.variableStartIndex.Count ? (taskSerializationData.startIndex == null || taskSerializationData.startIndex.Count <= 0 ? serializationData.startIndex.Count : taskSerializationData.startIndex[0]) : taskSerializationData.variableStartIndex[index1 + 1];
        fieldIndexMap.Clear();
    ...
    else
    {
      for (int index3 = 0; index3 < taskSerializationData.parentIndex.Count; ++index3)
      {
        ...
        else if (taskSerializationData.parentIndex[index3] != -1 && taskList[taskSerializationData.parentIndex[index3]] is ParentTask parentTask)
        {
  ...
  public static void Load(GlobalVariables globalVariables, string version)
  {
    ...
    FieldSerializationData serializationData;
    if (globalVariables.VariableData == null || ((serializationData = globalVariables.VariableData.fieldSerializationData).byteData == null || serializationData.byteData.Count == 0) && (serializationData.byteDataArray == null || serializationData.byteDataArray.Length == 0))
      return;
    ...
    if (BinaryDeserialization.updatedSerialization)
    {
      ...
      if (BinaryDeserialization.shaHashSerialization)
      {
        ...
        if (BinaryDeserialization.strHashSerialization)
        {
          BinaryDeserialization.animationCurveAdvance = version1.CompareTo(new Version("1.5.12")) < 0 ? 20 : 16;
          BinaryDeserialization.enumSerialization = version1.CompareTo(new Version("1.6.4")) >= 0;
        }
      }
    }
    ...
    for (int index1 = 0; index1 < variableData.variableStartIndex.Count; ++index1)
    {
      ...
      int num3 = index1 + 1 >= variableData.variableStartIndex.Count ? serializationData.startIndex.Count : variableData.variableStartIndex[index1 + 1];
      fieldIndexMap.Clear();
      for (int index2 = num2; index2 < num3; ++index2)
        fieldIndexMap.Add(serializationData.fieldNameHash[index2], serializationData.startIndex[index2]);
    ...
    ref BehaviorSource behaviorSource)
  {
    ...
    if (instance is UnknownTask)
    {
      ...
      for (int index4 = index1; index4 < num1; ++index4)
      {
        ...
        unknownTask.startIndex.Add(fieldSerializationData.startIndex[index4] - fieldSerializationData.startIndex[index1]);
      }
      for (int index5 = fieldSerializationData.startIndex[index1]; index5 <= fieldSerializationData.startIndex[num1 - 1]; ++index5)
        unknownTask.dataPosition.Add(fieldSerializationData.dataPosition[index5] - fieldSerializationData.dataPosition[fieldSerializationData.startIndex[index1]]);
      int num2 = count + 1 >= taskSerializationData.startIndex.Count || taskSerializationData.startIndex[count + 1] >= fieldSerializationData.dataPosition.Count ? fieldSerializationData.byteDataArray.Length : fieldSerializationData.dataPosition[taskSerializationData.startIndex[count + 1]];
      for (int index6 = fieldSerializationData.dataPosition[fieldSerializationData.startIndex[index1]]; index6 < num2; ++index6)
    ...
    instance.ID = (int) BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (int), "ID", 0, (IVariableSource) null);
    instance.FriendlyName = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (string), "FriendlyName", 0, (IVariableSource) null) as string;
    instance.IsInstant = (bool) BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (bool), "IsInstant", 0, (IVariableSource) null);
    object obj;
    if ((obj = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (bool), "Disabled", 0, (IVariableSource) null)) != null)
    ...
    Task task)
  {
    ...
    nodeData.Offset = (Vector2) BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (Vector2), "NodeDataOffset", 0, (IVariableSource) null);
    nodeData.Comment = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (string), "NodeDataComment", 0, (IVariableSource) null) as string;
    nodeData.IsBreakpoint = (bool) BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (bool), "NodeDataIsBreakpoint", 0, (IVariableSource) null);
    nodeData.Collapsed = (bool) BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (bool), "NodeDataCollapsed", 0, (IVariableSource) null);
    object obj1 = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (int), "NodeDataColorIndex", 0, (IVariableSource) null);
    if (obj1 != null)
      nodeData.ColorIndex = (int) obj1;
    object obj2 = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (List<string>), "NodeDataWatchedFields", 0, (IVariableSource) null);
    if (obj2 != null)
    {
    ...
    IVariableSource variableSource)
  {
    ...
    {
      if (!TaskUtility.HasAttribute(serializableFields[index], typeof (NonSerializedAttribute)) && (!serializableFields[index].IsPrivate && !serializableFields[index].IsFamily || TaskUtility.HasAttribute(serializableFields[index], typeof (SerializeField))) && (!(obj is ParentTask) || !serializableFields[index].Name.Equals("children")))
      {
        object objA = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, serializableFields[index].FieldType, serializableFields[index].Name, hashPrefix, variableSource, obj, serializableFields[index]);
        if (objA != null && !object.ReferenceEquals(objA, (object) null) && !objA.Equals((object) null) && serializableFields[index].FieldType.IsAssignableFrom(objA.GetType()))
    ...
    FieldInfo fieldInfo = null)
  {
    ...
    if (!flag && fieldInfo != (FieldInfo) null && fieldInfo.GetCustomAttribute(typeof (FormerlySerializedAsAttribute), true) is FormerlySerializedAsAttribute customAttribute)
    {
      num2 = hashPrefix + BinaryDeserialization.StringHash(fieldType.Name.ToString(), BinaryDeserialization.strHashSerialization) + BinaryDeserialization.StringHash(customAttribute.oldName, BinaryDeserialization.strHashSerialization);
    ...
    {
      if (fieldInfo != (FieldInfo) null && TaskUtility.HasAttribute(fieldInfo, typeof (InspectTaskAttribute)))
      {
        string typeName = BinaryDeserialization.BytesToString(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3], BinaryDeserialization.GetFieldSize(fieldSerializationData, num3));
      ...
      else
      {
        ...
        int num4 = BinaryDeserialization.BytesToInt(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
      ...
      obj1 = (object) BinaryDeserialization.BytesToSharedVariable(fieldSerializationData, fieldIndexMap, fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3], variableSource, true, num2);
    else if (typeof (UnityEngine.Object).IsAssignableFrom(fieldType))
      obj1 = (object) BinaryDeserialization.IndexToUnityObject(BinaryDeserialization.BytesToInt(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]), fieldSerializationData);
    else if (fieldType.Equals(typeof (int)) || !BinaryDeserialization.enumSerialization && fieldType.IsEnum)
    {
      obj1 = (object) BinaryDeserialization.BytesToInt(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
      if (fieldType.IsEnum)
        obj1 = Enum.ToObject(fieldType, obj1);
    }
    else if (fieldType.IsEnum)
      obj1 = Enum.ToObject(fieldType, BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, Enum.GetUnderlyingType(fieldType), fieldName, num2, variableSource, obj, fieldInfo));
    else if (fieldType.Equals(typeof (uint)))
      obj1 = (object) BinaryDeserialization.BytesToUInt(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (ulong)) || fieldType.Equals(typeof (ulong)))
      obj1 = (object) BinaryDeserialization.BytesToULong(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (ushort)))
      obj1 = (object) BinaryDeserialization.BytesToUShort(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (float)))
      obj1 = (object) BinaryDeserialization.BytesToFloat(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (double)))
      obj1 = (object) BinaryDeserialization.BytesToDouble(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (long)))
      obj1 = (object) BinaryDeserialization.BytesToLong(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (ulong)))
      obj1 = (object) BinaryDeserialization.BytesToULong(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (bool)))
      obj1 = (object) BinaryDeserialization.BytesToBool(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (string)))
      obj1 = (object) BinaryDeserialization.BytesToString(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3], BinaryDeserialization.GetFieldSize(fieldSerializationData, num3));
    else if (fieldType.Equals(typeof (byte)))
      obj1 = (object) BinaryDeserialization.BytesToByte(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Vector2)))
      obj1 = (object) BinaryDeserialization.BytesToVector2(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Vector2Int)))
      obj1 = (object) BinaryDeserialization.BytesToVector2Int(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Vector3)))
      obj1 = (object) BinaryDeserialization.BytesToVector3(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Vector3Int)))
      obj1 = (object) BinaryDeserialization.BytesToVector3Int(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Vector4)))
      obj1 = (object) BinaryDeserialization.BytesToVector4(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Quaternion)))
      obj1 = (object) BinaryDeserialization.BytesToQuaternion(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Color)))
      obj1 = (object) BinaryDeserialization.BytesToColor(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Rect)))
      obj1 = (object) BinaryDeserialization.BytesToRect(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (Matrix4x4)))
      obj1 = (object) BinaryDeserialization.BytesToMatrix4x4(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (AnimationCurve)))
      obj1 = (object) BinaryDeserialization.BytesToAnimationCurve(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
    else if (fieldType.Equals(typeof (LayerMask)))
      obj1 = (object) BinaryDeserialization.BytesToLayerMask(fieldSerializationData.byteDataArray, fieldSerializationData.dataPosition[num3]);
  ...
  private static int GetFieldSize(FieldSerializationData fieldSerializationData, int fieldIndex) => (fieldIndex + 1 >= fieldSerializationData.dataPosition.Count ? fieldSerializationData.byteDataArray.Length : fieldSerializationData.dataPosition[fieldIndex + 1]) - fieldSerializationData.dataPosition[fieldIndex];
  ...
  private static bool BytesToBool(byte[] bytes, int dataPosition) => BitConverter.ToBoolean(bytes, dataPosition);
  ...
  public static uint crc32(byte[] input, int dataPosition, int dataSize)
  {
    ...
    for (int index = dataPosition; index < dataPosition + dataSize; ++index)
      num1 = num1 >> 8 ^ BinaryDeserialization.crcTable[(int) (uint) (((int) num1 ^ (int) input[index]) & (int) byte.MaxValue)];
  ...
  private static byte BytesToByte(byte[] bytes, int dataPosition) => bytes[dataPosition];
  ...
  private static Matrix4x4 BytesToMatrix4x4(byte[] bytes, int dataPosition)
  {
    return new Matrix4x4(){
      m00 = BinaryDeserialization.BytesToFloat(bytes, dataPosition),
      m01 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 4),
      m02 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 8),
      m03 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 12),
      m10 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 16),
      m11 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 20),
      m12 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 24),
      m13 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 28),
      m20 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 32),
      m21 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 36),
      m22 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 40),
      m23 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 44),
      m30 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 48),
      m31 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 52),
      m32 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 56),
      m33 = BinaryDeserialization.BytesToFloat(bytes, dataPosition + 60)
    };
  }
  ...
  private static AnimationCurve BytesToAnimationCurve(byte[] bytes, int dataPosition)
  {
    ...
    animationCurve.preWrapMode = (WrapMode) BinaryDeserialization.BytesToInt(bytes, dataPosition + 4);
    animationCurve.postWrapMode = (WrapMode) BinaryDeserialization.BytesToInt(bytes, dataPosition + 8);
    return animationCurve;
  }

  private static LayerMask BytesToLayerMask(byte[] bytes, int dataPosition) => new LayerMask()
  {
  ...
  {
    return index < 0 || index >= activeFieldSerializationData.unityObjects.Count ? (UnityEngine.Object) null : activeFieldSerializationData.unityObjects[index];
  }
    ...
    int hashPrefix)
  {
    ...
    string typeName = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (string), "Type", hashPrefix, (IVariableSource) null) as string;
    if (string.IsNullOrEmpty(typeName))
      return (SharedVariable) null;
    string name = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (string), "Name", hashPrefix, (IVariableSource) null) as string;
    ...
    if (boolean1 && (!boolean3 || BehaviorManager.IsPlaying) && fromField)
    {
      ...
      {
        if ((UnityEngine.Object) BinaryDeserialization.globalVariables == (UnityEngine.Object) null)
    ...
    if (sharedVariable == null || !(flag = sharedVariable.GetType().Equals(typeWithinAssembly)))
    {
      ...
      sharedVariable.Tooltip = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (string), "Tooltip", hashPrefix, (IVariableSource) null) as string;
      if (!boolean2)
      {
        sharedVariable.PropertyMapping = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (string), "PropertyMapping", hashPrefix, (IVariableSource) null) as string;
        sharedVariable.PropertyMappingOwner = BinaryDeserialization.LoadField(fieldSerializationData, fieldIndexMap, typeof (GameObject), "PropertyMappingOwner", hashPrefix, (IVariableSource) null) as GameObject;
  ...
  private class ObjectFieldMapComparer : IEqualityComparer<BinaryDeserialization.ObjectFieldMap>
  {
    ...
    {
      return !object.ReferenceEquals((object) a, (object) null) && !object.ReferenceEquals((object) b, (object) null) && a.obj.Equals(b.obj) && a.fieldInfo.Equals((object) b.fieldInfo);
    }

    public int GetHashCode(BinaryDeserialization.ObjectFieldMap a) => a != null ? a.obj.ToString().GetHashCode() + a.fieldInfo.ToString().GetHashCode() : 0;
  }
}
