...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityPhysics2D
{
    ...
    public class Raycast : Action
    {
        ...
        [Tooltip("The direction of the ray")] public SharedVector2 direction;
        ...
        [SharedRequired] [Tooltip("Stores the hit object of the raycast.")]
        public SharedGameObject storeHitObject;

        [SharedRequired] [Tooltip("Stores the hit point of the raycast.")]
        public SharedVector2 storeHitPoint;

        [SharedRequired] [Tooltip("Stores the hit normal of the raycast.")]
        public SharedVector2 storeHitNormal;

        [SharedRequired] [Tooltip("Stores the hit distance of the raycast.")]
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            {
                position = originGameObject.Value.transform.position.Tofloat2();
                if (space == Space.Self)
                {
                    dir = originGameObject.Value.transform.TransformDirection(direction.Value.ToVector3()).Tofloat2();
                }
            }
            else
            {
