...
namespace Bonsai.Designer
{
    public class BonsaiViewer
    {
        ...
        {
            get { return BonsaiPreferences.Instance.zoomDelta; }
        }

        public static float MinZoom
        {
            get { return BonsaiPreferences.Instance.minZoom; }
        }

        public static float MaxZoom
        {
            get { return BonsaiPreferences.Instance.maxZoom; }
        }

        public static float PanSpeed
        {
            get { return BonsaiPreferences.Instance.panSpeed; }
        }
        ...
        private static void GetCompositeParent(BonsaiNode aborter, out BonsaiNode compositeParent,
            out BonsaiNode directChild)
        {
            directChild = aborter;
