...
namespace Bonsai.Core
{
    ...
    public abstract class ParallelComposite : Composite
    {
        ...
        protected NodeStatus[] ChildStatuses { get; private set; }

        public override void OnStart()
        {
            int count = ChildCount();
            ChildStatuses = new NodeStatus[count];
        ...
        public override void OnEnter()
        {
            ...
            {
                ChildStatuses[i] = NodeStatus.Running;
        ...
        protected bool IsAnyChildWithStatus(NodeStatus expected)
        {
        ...
        protected bool AreAllChildrenWithStatus(NodeStatus expected)
        {
            foreach (var status in ChildStatuses)
            {
                if (status != expected)
